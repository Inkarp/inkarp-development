...
import WorldMap from '../components/pages/Home/WorldMap';
import GlobalMap from '../components/pages/Home/GlobalMap';
import HomeOfferings from '../components/pages/Home/HomeOfferings';
import HomeVertcials from '../components/pages/Home/HomeVerticals';
