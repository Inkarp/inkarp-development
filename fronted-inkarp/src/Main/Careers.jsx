...
const team = [
  { name: "D. Saritha – Manager, Commercials", quote: "Mentoring and freedom at Inkarp shaped my career. Proud of our impact; excited for what’s next.", img: "https://source.unsplash.com/featured/?woman,manager" },
  { name: "M. Srinivas – General Manager", quote: "23+ years of opportunity and supportive leadership. Grateful for growth and confident we’ll keep leading.", img: "https://source.unsplash.com/featured/?man,manager" },
  { name: "I. Hari Krishna – Warehouse Incharge", quote: "Joining in 1992 was a turning point. Thankful for leadership support. Proud of our impact and future.", img: "https://source.unsplash.com/featured/?man,warehouse" },
  { name: "L. Vijaya Bhaskar – Service Manager", quote: "21 years of growth and lasting relationships. Thankful for trust and support; excited for more milestones.", img: "https://source.unsplash.com/featured/?man,engineer" },
  { name: "Dasari Raju", quote: "Inkarp isn’t just a workplace — it’s where passion meets purpose.", img: "https://source.unsplash.com/featured/?portrait,business" },
  { name: "Praneeth", quote: "You’re encouraged to grow — not just in role, but in vision.", img: "https://source.unsplash.com/featured/?woman,leader" },
  { name: "Sharath", quote: "Ownership, learning, and impact are part of everyday work.", img: "https://source.unsplash.com/featured/?man,leader" },
  { name: "Pavan", quote: "A culture that listens, trusts, and enables you to do your best work.", img: "https://source.unsplash.com/featured/?woman,engineer" },
  { name: "Sanghavi", quote: "We celebrate ideas and encourage experimentation.", img: "https://source.unsplash.com/featured/?man,professional" },
  { name: "Apoorva", quote: "Growth here isn’t a buzzword—it’s a roadmap.", img: "https://source.unsplash.com/featured/?business,woman" },
];
                ...
                {visibleTeam.map((m, k) => (
                  ...
                  >
                    <div className="flex items-center gap-4">
                      ...
                      {/* <img
                        src={m.img}
                        alt={m.name.charAt(0).toUpperCase()} // first name alt
                        className="h-10 w-10 rounded-full object-cover border-2 border-[#E63946]"
                      /> */}
                      {/* <div className="h-10 w-10 rounded-full flex items-center justify-center object-cover border-2 border-[#E63946] bg-[#F5F5F5]">
