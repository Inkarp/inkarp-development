    ...
    <>
      ...
      <section className="px-2 md:px-12 mx-auto font-['Roboto']">
        <div className="flex flex-col  lg:flex-row justify-center items-center gap-8">
          {/* Left Side */}
          <div className="w-full lg:w-1/4 text-center sm:text-right md:text-left bg-black lg:text-left">
          ...
          {/* India Map */}
          <div className="relative w-full mx-auto rounded-xl bg-black ">
            ...
            {branches.map((branch, index) => {
              ...
              return (
                ...
                >
                  <div className="relative z-[10000] w-6 h-6 flex">
                    {/* <div className="w-5 h-5 bg-[Be0010] rounded-full location-ping absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-0" />
                    <div className="w-3 h-3 bg-[#E63946] border border-white rounded-full absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 shadow-md z-10" /> */}
                    <LocateIcon />
                  </div>
