            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                ...
                <div className="lg:col-span-3">
                    <div className="py-3 flex flex-col items-start justify-center gap-3 max-w-md">
                        <DroppingText />
                        <h3 className="font-[MaxOT] text-center text-xl sm:text-2xl text-[#E63946] leading-tight">
                            Innovation is our core our subsidiaries and joint ventures power the INKARP vision forward.
                        </h3>
