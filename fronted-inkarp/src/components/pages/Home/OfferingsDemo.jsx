...
const profiles = [
  ...
  },
  {
    ...
    description:
      "Delivering precise analytical instrumentation to ensure peak resolution and unmatched data reproducibility.",
    image: Chromato,
  ...
  },
  {
    ...
    description:
      "Advanced material characterization and thermal analysis tools for energy storage, semiconductors, and polymers.",
    image: Material,
    icon: BatteryIcon,
    socials: { whatsapp: "https://wa.me/918019828999" },
  },
  {
    ...
    description:
      "Designing and implementing pilot-scale automation for chemical and pharmaceutical scale-ups.",
    image: PilotPlants,
    icon: PilotIcon,
    socials: { whatsapp: "https://wa.me/918019828999" },
  },
  {
    ...
    description:
      "Empowering biological breakthroughs with cutting-edge cell analysis, imaging, and molecular biology platforms.",
    image: Lifescience,
    icon: LifeIcon,
    socials: { whatsapp: "https://wa.me/918019828999" },
  },
  {
    ...
    description:
      "Delivering high-pressure homogenization and extrusion equipment for nanoemulsions, dispersions, and formulations.",
    image: Hemo,
    icon: ExtrusionIcon,
    socials: { whatsapp: "https://wa.me/918019828999" },
  },
  {
    ...
    description:
      "Measuring material behavior and thermal properties with precision rheometers and calorimeters.",
    image: Thermal,
    icon: ThermalIcon,
    socials: { whatsapp: "https://wa.me/918019828999" },
  },
  {
    ...
    description:
      "From pH meters to water purification – your everyday research essentials under one roof.",
    image: General,
    icon: GeneralIcon,
    socials: { whatsapp: "https://wa.me/918019828999" },
  },
  ...
  return (
    <div className="group relative h-full bg-[#0F2A33] text-white border border-white/10 hover:border-[#E63946] transition-colors duration-300">
      ...
      <div className="p-8 md:p-9 lg:p-10 h-full flex flex-col">
        ...
        <Link
          to={profile.link}
          className="mt-auto pt-5 inline-block text-xs tracking-wider font-[MaxOT] uppercase text-white/80 relative after:block after:h-[1px] after:bg-gradient-to-r after:from-[#BE0010] after:to-[#E63946] after:w-0 hover:after:w-full after:transition-all after:duration-300"
        >
          Read more
        </Link>
      </div>
...
export default function OfferingsDemo() {
  return (
    <section className="relative w-[98%] mx-auto py-12 md:px-10 lg:px-20">
      ...
      {/* heading */}
      <div className="text-left md:text-center flex flex-col items-center justify-center gap-3">
        <span
        ...
        <h2 className="text-xl sm:text-2xl font-[MaxOT] text-white leading-tight">
          ...
          <h2 className="text-xl sm:text-2xl font-[MaxOT] text-white leading-tight flex flex-wrap gap-1">
