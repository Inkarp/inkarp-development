...
import InkarpLogo from "/inkarpOld.svg";
...
const subsidiaries = [
  ...
  { name: "Group Company", image: InkarpTelecom, icon: <PhoneCall className="w-3 h-3 text-white" aria-hidden="true" /> },
  { name: "Group Company", image: InkarpServices, icon: <Wrench className="w-3 h-3 text-white" aria-hidden="true" /> },
                    ...
                    <div className="card flex justify-center items-center ">
                      ...
                      {subsidiary.text ? (
                        ...
                        <div className="flex jutsify-center items-center ">
                          {subsidiary.icon ? (<span className="p-2 bg-[#E63946] rounded-full">{subsidiary.icon}</span>) : null}
                          <img
