import NanalysisLogo from '/src/assets/PrincipalLogos/RowOne/nanalysis.png';

// ---------- Images Imported Earlier ----------
...
// -------------------------------------------------------
//     FINAL Nanalysis + Waters + Labomatic + Advion STRUCTURE
// -------------------------------------------------------

export const ChromoSolutions = {
  vertical: "Analytical and Chromatography Solutions",
  principal: "Nanalysis / Waters / Labomatic / Advion",
  logo: NanalysisLogo,
  ...
  products: [
    ...
    // ---------------------- Preparative Columns ----------------------
    {
      ...
      slug: "columns-for-preparative-chromatography",
      models: [
    ...
    // ---------------------- PLC Industrial Systems ----------------------
    {
      ...
      models: [
        { name: "Separsys HP 400 / 800 FP / 300 DS", slug: "separsys-hp-series", image: ImgSeparsys400 },
      ],
    },
    ...
    // ---------------------- AVANT HPLC ----------------------
    {
      ...
      slug: "avant-u-hplc",
      models: [
        { name: "AVANT™ (U)HPLC System", slug: "avant-u-hplc", image: AVANT2019FINAL },
      ],
    },
    ...
    // ---------------------- Preparative Purification ----------------------
    {
      ...
      slug: "preparative-purification-systems",
      models: [
    ...
    // ---------------------- MS Detection Devices ----------------------
    {
      name: "peripheral-detection-devices",
      slug: "peripheral-detection-devices",
      models: [
        { name: "puriFlash® MS", slug: "puriflash-ms", image: PuriFlashMS2 },
      ],
    },
    ...
    // ---------------------- Production Devices ----------------------
    {
      ...
      models: [
        { name: "Autosampler puriFlash AS-1", slug: "autosampler-puriflash-as-1", image: PuriFlashAS1Interchim },
        { name: "puriFlash XS-Vap", slug: "puriflash-xs-vap", image: SystemeBainEauPuriFlashXSVap },
        { name: "Evaporator puriVap-6", slug: "evaporator-purivap-6", image: Purivap6Goutte },
      ],
    },
  ],
};
