...
const productLinks = {
  nanalysis: "https://www.nanalysis.com/?_gl=1*16yi4hl*_ga*MjA2ODEwMDMxMC4xNzYxMjE3OTgx*_up*MQ..",
  waters: "https://www.waters.com/nextgen/in/en.html",
  ecom: "https://www.ecomsro.com/",
  advioninterchim: "https://www.advion.com/",
  labomatic: "https://www.labomatic.com/en",
};
            ...
            {product?.techSpecs?.specs && Object.keys(product.techSpecs.specs).length > 0 && (
              <div className="py-8 sm:px-4 lg:px-8 w-full max-w-7xl mx-auto">
                <div className="bg-gray-50 shadow-xl overflow-hidden rounded-3xl p-4 sm:p-6 md:p-8 border border-gray-200">
                  <h2 className="text-2xl sm:text-3xl font-bold text-[#E63946] text-center font-[MaxOT] mb-6">
