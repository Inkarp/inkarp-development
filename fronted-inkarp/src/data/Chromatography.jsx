    ...
    "peripheral-detection-devices": {
     ...
     "peripheral-production-devices": {
        models: [
            { heading: "" },
            {
                name: "Autosampler puriFlash® AS-1",
                slug: "autosampler-puriflash-as-1",
                image: PuriFlashAS1Interchim
            },
              {
                name: "puriFlash® XS-Vap",
                slug: "puriflash-xs-vap",
                image:SystemeBainEauPuriFlashXSVap
            },
              {
                name: "Evaporator puriVap-6",
                slug: "evaporator-purivap-6",
                image: Purivap6Goutte
            }
        ],
        meta: {
            title: "Peripheral Detection Devices | Advion Interchim Scientific | Inkarp India",
