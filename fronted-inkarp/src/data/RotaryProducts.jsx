...
`,
    ...
    "magnetic-stirrers": {
        models: [
            {'heading': "Magnetic Stirrers for Your Research",   },
        ...
        models: [
            {
                ...
                slug: "sphericalplate-5d", // corrected slug
                image: SphericalPlate,
                description:
                    "3D cell culture plate enabling fast, uniform spheroid and organoid formation without hydrogels—designed for gentle handling and high reproducibility across assays.",
            },
        ],
        meta: {
            title:
                "Kugelmeiers Sphericalplate 5D (SP5D) – 3D Cell Culture Plate | Distributor & Service in India | Inkarp",
            description:
                "Explore the Kugelmeiers Sphericalplate 5D (SP5D) for standardized, hydrogel-free 3D spheroid and organoid culture. Distributed and serviced in India by Inkarp.",
            keywords: [
                "Kugelmeiers Sphericalplate 5D",
                "SP5D",
                "Sphericalplate 5D India",
                "3D cell culture plate",
                "Spheroid culture plate",
                "Organoid culture plate",
                "Hydrogel-free 3D culture",
                "Kugelmeiers distributor India",
                "Smart cell cultivation",
                "Inkarp scientific equipment"
            ],
            altText: "Kugelmeiers Sphericalplate 5D (SP5D) – 3D Cell Culture Plate",
            internalLinks: [
                "/verticals/smart-cell-cultivation",
                "/verticals/smart-cell-cultivation/sphericalplate-5d"
            ],
            externalLinks: ["https://www.kugelmeiers.com/"] // replace/keep per your linking policy
        }
    }
};
