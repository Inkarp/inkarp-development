...
export const AdvionProducts = {
    "express-cms": {
        ...
        meta: {
            ...
            keywords: [
                "expression® CMS, Advion Interchim expression® CMS, Advion Interchim, Inkarp",
                "expression CMS",
    ...
    <div style="flex:1 1 60%;min-width:300px;">
        <div ">
            <div style="margin-bottom:10px;font-size:18px;line-height:1.6;">
                <p>Experience the power of expression CMS, a Compact Mass Spectrometer, distributed and serviced by Advion Interchim and Inkarp Instruments in India. This innovative system offers High-performance mass spectrometry, Compact design for laboratory settings, Easy-to-use interface, Affordable pricing. Unlock the full potential of your laboratory with expression CMS and experience the benefits of Advion Interchim's cutting-edge technology and Inkarp's dedicated support.
                </p>
                <p style="font-family:;margin-bottom:10px; class="text-black">High performance compact mass spectrometer</p>
                ...
                <h2 class="text-[#E63946] text-xl font-[MaxOT] py-3">Unrivaled utility and flexibility</h2>
...
<div style="margin-top:30px;" class="font-[Roboto] text-[18px] ">
...
<div style="margin-top:20px;">
    <h2 class="text-[#E63946] text-xl font-[MaxOT] py-3">Videos</h2>
...
`
    ...
    "plate-express": {
        ...
        meta: {
            ...
            keywords: [
                "Plate Express™, Plate Express™ Advion Interchim, Advion Interchim, Inkarp",
                "Plate Express",
                "TLC Plate Reader",
...
<div style="display:flex;flex-wrap:wrap;gap:20px;font-family:Roboto,;color:#333;">
    <div style="flex:1 1 60%;min-width:300px;">
        <div style="padding-left:20px;">
            <div style="margin-bottom:10px;font-size:18px;line-height:1.6;">
                <p>Revolutionize your sample preparation with Plate Express, a high-throughput plate preparation system, distributed and serviced by Advion Interchim and Inkarp Instruments in India. This innovative system offers Rapid and precise sample preparation, High-density plate formatting, Automated liquid handling, Increased laboratory productivity. Experience the benefits of Advion Interchim's cutting-edge technology and Inkarp's dedicated support for your laboratory requirements.
                </p>
                <p style="font-family:MaxOT;margin-bottom:10px;color:#E63946;font-weight:600;">Automated TLC plate reader</p>
                <p>Plate Express™ is a device that provides a simple, automated means of obtaining mass spectra directly from TLC plates, combined with Scientific’s expression® Compact Mass Spectrometer (CMS) creating a technique known as TLC/CMS.</p>
                <h2 style="margin-top:15px;font-weight:700;color:#E63946;">Direct mass analysis from TLC plates</h2>
...
<div style="margin-top:30px;">
    <h2 class="font-[#E63946] text-xl font-[MaxOT]">Videos</h2>
...
<div style="display:flex;flex-wrap:wrap;gap:20px;font-family:Roboto,Arial,sans-serif;color:#333;">
    <div style="flex:1 1 60%;min-width:300px;">
        <div >
            <div style="margin-bottom:10px;font-size:18px;line-height:1.6;">
                <p>Experience the future of liquid chromatography with AVANT (U)HPLC, a cutting-edge system distributed and serviced by Advion Interchim and Inkarp Instruments in India. This innovative platform offers Unparalleled flexibility and scalability, Ultra-high performance and speed, Advanced column management, Seamless integration with mass spectrometry. Unlock the full potential of your research with AVANT (U)HPLC and experience the benefits of Advion Interchim's innovative technology and Inkarp's dedicated support.
                </p>
                <p style="font-family:;margin-bottom:10px;font-weight:600;">Modular chromatography systems</p>
                ...
                <h2 style="margin-top:15px;font-weight:700;color:#E63946;" class="font-[MaxOT]">Chromatography solutions for LC/CMS and standalone LC</h2>
...
<div style="margin-top:30px;" class="font-[Roboto] text-[18px] space-y-2">
...
`
    ...
    "solation-icp-ms": {
        ...
        meta: {
            ...
            keywords: [
                "SOLATION® ICP-MS, Advion Interchim SOLATION® ICP-MS, Advion Interchim, Inkarp",
                "SOLATION ICP-MS",
...
<div style="display:flex;flex-wrap:wrap;gap:20px;font-family:Roboto,Arial,sans-serif;color:#333;">
  <div style="flex:1 1 60%;min-width:300px;">
    <div style="padding-left:20px;">
      <div style="margin-bottom:10px;font-size:18px;line-height:1.6;">
        <p>Discover the ultimate solution for trace element analysis with SOLATION ICP-MS, distributed and serviced by Advion Interchim and Inkarp Instruments in India. This high-performance system offers Exceptional sensitivity and accuracy, Fast data acquisition and analysis, Advanced interference removal, User-friendly interface. Experience the benefits of Advion Interchim's innovative technology and Inkarp's dedicated support for your laboratory requirements.</p>
        <p style=";margin-bottom:10px;font-weight:600;">Inductively coupled plasma mass spectrometry</p>
        ...
        <h2  class="font-[MaxOT] text-xl text-[#E63946] py-3 ">Simple, high-performance, robust multi-element analysis</h2>
...
`
    ...
    "triversa-nanomate": {
        ...
        meta: {
            ...
            keywords: [
                "TriVersa NanoMate® , TriVersa NanoMate® Advion Interchim, Advion Interchim, Inkarp",
                "TriVersa NanoMate",
                "Advion NanoMate",
...
<div style="display:flex;flex-wrap:wrap;gap:20px;font-family:Roboto;color:#333;">
    <div style="flex:1 1 60%;min-width:300px;">
        <div style="">
            <div style="margin-bottom:10px;font-size:18px;line-height:1.6;">
                <p>Experience the power of TriVersa NanoMate, a pioneering nanoelectrospray ionization (nESI) source, distributed and serviced by Advion Interchim and Inkarp Instruments in India. This innovative system offers Enhanced sensitivity and reproducibility, Seamless integration with MS instruments, Automated sample handling, Increased laboratory productivity. Unlock the full potential of your MS experiments with TriVersa NanoMate and experience the benefits of Advion Interchim's cutting-edge technology and Inkarp's dedicated support.</p>
                <p style="margin-bottom:10px;font-weight:600;">Nanoelectrospray ionization technology</p>
                ...
                <h2 class="font-[MaxOT] text-xl text-[#E63946] py-3">Obtain more information from complex samples than LC/MS alone</h2>
...
<div style="margin-top:30px;" class="font-[Roboto] text-[18px] space-y-2">
    <h2 style="color:#E63946;font-weight:700;">Advion ESI Chip®</h2>
...
<div style="margin-top:30px;">
    <h2 class="text-xl text-[#E63946] font-[MaxOT]">Videos</h2>
    <div style="display:flex;flex-wrap:wrap;gap:20px;margin-top:10px;">
        <div style="flex:1;min-width:280px;">
...
`
    ...
    "puriflash-xs-520-plus": {
        ...
        meta: {
            ...
            keywords: [
                "Puriflash® Xs 520 Plus, Puriflash® Xs 520 Plus Flash Purification Systems, Advion Interchim Puriflash® Xs 520 Plus, Advion Interchim, Inkarp",
                "Puriflash Xs 520 Plus",
...
<div style="display:flex;flex-wrap:wrap;gap:20px;font-family:Roboto,Arial,sans-serif;color:#333;">
    <div style="flex:1 1 60%;min-width:300px;">
        <div style="padding-left:20px;">
            <div style="margin-bottom:10px;font-size:18px;line-height:1.6;" class="font-[Roboto] space-y-2">
                ...
                <p>Discover the ultimate in flash purification with Puriflash Xs 520 Plus, a cutting-edge system distributed and serviced by Advion Interchim and Inkarp Instruments in India. This advanced platform offers High-speed purification of complex mixtures, Unparalleled resolution and purity, Advanced method development and scalability & User-friendly interface. Experience the benefits of Advion Interchim's innovative technology and Inkarp's dedicated support for your laboratory requirements.
                </p>
                <h2 class="font-[MaxOT] text-xl text-[#E63946] py-3">Concentrated technology for unsurpassed performance</h2>
...
`
    ...
    "puriflash-5020": {
        ...
        meta: {
            ...
            keywords: [
                "Puriflash® 5.020, Puriflash® 5.020 Flash Purification Systems, Advion Interchim Puriflash® 5.020, Advion Interchim, Inkarp",
                "Puriflash 5.020",
                "Flash Purification Systems",
                "Advion Puriflash",
    ...
    <div style="flex:1 1 60%;min-width:300px;">
        <div style="padding-left:20px;">
            <div style="margin-bottom:10px;font-size:18px;line-height:1.6;" class="font-[Roboto] space-y-2">
                ...
                <p>Accelerate your purification process with Puriflash 5.020, a high-performance flash purification system, distributed and serviced by Advion Interchim and Inkarp Instruments in India. Ideal for pharmaceutical, biotech, and research applications, Puriflash 5.020 streamlines your workflow. Advion Interchim and Inkarp Instruments ensure premium support, including installation, training, and after-sales service, to meet your laboratory needs in India.
                </p>
                 <h2 class="font-[MaxOT] text-xl text-[#E63946] py-3">Technology that will give you valuable time</h2>
                <p>Spend your time working on purifications and on the management of your device only thanks to the integrated technology in the puriFlash® 5.020 (RFID detector, detectors for potential leakage and solvent level …)
                </p>
            </div>
        </div>
    </div>
...
`
    ...
    "puriflash-5050": {
        ...
        meta: {
            ...
            keywords: [
                "Puriflash® 5.050, Puriflash® 5.050 Flash Purification Systems, Advion Interchim Puriflash® 5.050, Advion Interchim, Inkarp",
                "Puriflash 5.050",
                "Flash Purification Systems",
    ...
    <div style="flex:1 1 60%;min-width:300px;">
        <div style="padding-left:20px;">
            <div style="margin-bottom:10px;font-size:18px;line-height:1.6;" class="font-[Roboto] space-y-2">
                ...
                <p>Unlock the power of flash purification with Puriflash 5.050, a cutting-edge system distributed and serviced by Advion Interchim and Inkarp Instruments in India. This advanced platform offers Unparalleled purification speed and resolution, Automated method development and optimization, High-throughput processing of complex mixtures & User-friendly interface and software. Experience the benefits of Advion Interchim's innovative technology and Inkarp's dedicated support for maximum productivity and efficiency.
                </p>
                <h2 class="font-[MaxOT] text-xl text-[#E63946]">Performance and versatility in every situation</h2>
                <p>The puriFlash® 5.050 is a unique instrument to successfully perform preparative and flash purifications, moving from normal to the reverse phase and working with reusable columns. And ultimately a more ecological approach to purification.</p>
                
               <h2 class="font-[MaxOT] text-xl text-[#E63946]">Achieve greater purity</h2>
                <p>With a max. pressure of 50 bar, it is the ideal device for accessing the preparative chromatography while allowing you to simultaneously perform Flash purification.</p>
                <p>Indeed, for more complex reprocessing in reverse phase, the use of stainless steel columns filled with low particle size phases is the preferred instrument for successful separations.</p>
            </div>
        </div>
    </div>
</div>
`
    ...
    "puriflash-535-xl": {
        ...
        meta: {
            ...
            keywords: [
                "Puriflash® 535-xl, Puriflash® 535-xl Flash Purification Systems, Advion Interchim Puriflash® 535-xl, Advion Interchim, Inkarp",
                "Puriflash 535-XL",
                "Flash Purification Systems",
...
<div style="display:flex;flex-wrap:wrap;gap:20px;font-family:Roboto;color:#333;">
    <div style="flex:1 1 60%;min-width:300px;">
        <div style="padding-left:20px;">
            <div style="margin-bottom:10px;font-size:18px;line-height:1.6;" class="font-[Roboto] space-y-2">
                <p>Puriflash 535-xl, distributed and serviced by Advion Interchim and Inkarp Instruments in India, is a cutting-edge flash purification system designed for high-end pharmaceutical, biotech, and research applications, offering unparalleled purification speed and resolution, automated method development and optimization, and high-throughput processing of complex mixtures, with premium support from Advion Interchim and Inkarp Instruments to ensure maximum productivity and efficiency in your laboratory.
                </p>
                <p style="font-weight:500;">Your ideal tool for high-throughput purification of raw product.</p>

                 <h2 class="font-[MaxOT] text-xl text-[#E63946]">Small but mighty</h2>
                <p>The puriFlash® 535-XL has the advantages of the puriFlash® XS 520 Plus, and more. Customer-favorites including compact size, 15″ touch screen, interSoft® X featuring Genius software, UV detector, fraction collector, retention tank solvents, are just a few of the user-friendly components that make a difference.
                </p>
                <p>Using the 535-XL, the big brother of the puriFlash XS 520 Plus, you can purify a small to large amount of your product of interest with minimal runs. This is due to the power of the new double piston pump, which allows to work up to 400mL / min and 35 bar while maintaining good precision and repeatability.
                </p>
            </div>
        </div>
    </div>
    ...
    <div style="flex:1 1 60%;min-width:300px;">
        <div style="padding-left:20px;">
            <div style="margin-bottom:10px;font-size:16px;line-height:1.6;">
                <p>Puriflash 5.015-xl, distributed and serviced by Advion Interchim and Inkarp Instruments in India, is a high-performance flash purification system designed for efficient and effective separation of complex mixtures. Making it an ideal solution for pharmaceutical, biotech, and research applications, backed by premium support from Advion Interchim and Inkarp to ensure seamless integration and maximum productivity in your laboratory.
                </p>

                <h2 class="font-[MaxOT] text-xl text-[#E63946] py-3">The assurance of successful purifications</h2>
                <p>Its long-lasting reliability and robustness, as well as its safety features are key benefits to carrying out your productions semi-continously and with volumes of up to several hundred grams of the compounds of interest.</p>
...
<div style="display:flex;flex-wrap:wrap;gap:20px;font-family:Roboto,Arial,sans-serif;color:#333;">
    <div style="flex:1 1 60%;min-width:300px;">
        <div style="padding-left:20px;">
            <div style="margin-bottom:10px;font-size:18px;line-height:1.6;" class="font-[Roboto] space-y-2" class="font-[Roboto] space-y-2">
                <p>Streamline your purification process with Puriflash 5.250, a preparative purification system, distributed and serviced by Advion Interchim and Inkarp Instruments in India. This advanced system offers High-speed purification of complex mixtures, Unparalleled resolution and purity, Easy method development and scalability, User-friendly interface. Experience the benefits of Advion Interchim's innovative technology and Inkarp's dedicated support for your laboratory requirements.
                </p>
               <p>Experience the unique performance in all circumstances.</p>
               <p>The puriFlash® 5.250 adapts to all the requirements of routine purification, complex mixtures, separation of impurities for later detection, trace enrichment, etc.</p>
                <h2 class="font-[MaxOT] text-xl text-[#E63946] py-3">Maximum versatility and flexibility</h2>
                <p>The PF-5.250 purification system will become an indispensable ally in your laboratory. It has been thought through in great detail in order to meet all your needs, and the only question you will ask yourself during its operation, is how you have managed without it for so long.</p>
                <p>It is ready to start multiple purifications in normal or reverse phase, flash chromatography or preparative HPLC at any time. Ask of it whatever you like because it has the ability to do it all with its 250 bar and 250 mL/min – from routine purification to complex purification.</p>
            </div>
        </div>
    </div>
</div>
`
    ...
    "puriflash-5400uv": {
        ...
        meta: {
            ...
            keywords: [
                "Puriflash® 5.400uv, Puriflash® 5.400uv Preparative Purification Systems, Advion Interchim Puriflash® 5.400uv, Advion Interchim Inkarp",
                "Puriflash 5.400uv",
                "Preparative Purification Systems",
                "High-speed purification",
                "Advion Puriflash",
...
<div style="display:flex;flex-wrap:wrap;gap:20px;font-family:Roboto;color:#333;">
    <div style="flex:1 1 60%;min-width:300px;">
        <div style="padding-left:20px;">
            <div style="margin-bottom:10px;font-size:18px;line-height:1.6;" class="font-[Roboto] space-y-2">
                <p>Take your purification to the next level with Puriflash 5.400uv, a preparative purification system, distributed and serviced by Advion Interchim and Inkarp Instruments in India. This cutting-edge system offers Unparalleled UV detection sensitivity, High-speed purification of complex mixtures, Advanced method development and scalability, User-friendly interface. Experience the benefits of Advion Interchim's innovative technology and Inkarp's dedicated support for your laboratory requirements.
                </p>
                ...
                <h2 class="text-xl font-[MaxOT] text-[#E63946] py-3">Exceed the limits of purification</h2>
                <p>If you are striving for excellence, the puriFlash® 5.400-UV is perfect for you – from the development of the method on an small diameter column to the purification by preparative HPLC. In addition to the unparalleled performance of this purification system, conducting these steps on one device gives you greater flexibility and significant time savings, and increased productivity.</p>
                <p>The PuriFlash® 5.400-UV with its maximum pressure of 400 bar, is also compatible with the use of sub-2 micron columns for maximum separating power. This means that you will have access to ultra-purification for the purification of rare and high quality products</p>
            </div>
        </div>
    </div>
</div>
`
    ...
    <div style="flex:1 1 60%;min-width:300px;">
        <div style="padding-left:20px;">
            <div style="margin-bottom:10px;font-size:18px;line-height:1.6;" class="font-[Roboto] space-y-2">
                <p style="">Increasing your productivity has never been that easy</p>
                <p>Maximize your laboratory efficiency with Autosampler puriFlash AS-1, a cutting-edge peripheral production device, distributed and serviced by Advion Interchim and Inkarp Instruments in India. This innovative autosampler offers Automated sample injection, High-throughput processing, Enhanced data accuracy, Seamless integration with puriFlash systems. Experience the benefits of Advion Interchim's innovative technology and Inkarp's dedicated support for your laboratory requirements.
                </p>

                <h2 class="text-xl font-[MaxOT] text-[#E63946]">Simply let puriFlash® AS-1 work for you</h2>
        ...
        description: `
            <div style="display:flex;flex-wrap:wrap;gap:20px;font-family:Roboto;color:#333;">
                <div style="flex:1 1 60%;min-width:300px;">
                    <div style="padding-left:20px;">
                        <div style="margin-bottom:10px;font-size:18px;line-height:1.6;" class="font-[Roboto] space-y-2">
                            <p>Take your purification process to the next level with puriFlash XS-Vap, a cutting-edge peripheral production device, distributed and serviced by Advion Interchim and Inkarp Instruments in India. This innovative system offers Automated solvent evaporation, High-throughput processing, Enhanced sample concentration, Seamless integration with puriFlash systems. Experience the benefits of Advion Interchim's innovative technology and Inkarp's dedicated support for your laboratory requirements.
                            </p>
...
<div style="display:flex;flex-wrap:wrap;gap:20px;font-family:Roboto,sans-serif;color:#333;">
    <div style="flex:1 1 60%;min-width:300px;">
        <div style="padding-left:20px;">
            <div style="margin-bottom:10px;font-size:18px;line-height:1.6;" class="font-[Roboto] space-y-2">
                <p>Boost your laboratory productivity with Evaporator puriVap-6, a high-performance peripheral production device, distributed and serviced by Advion Interchim and Inkarp Instruments in India. This advanced evaporator offers Rapid and gentle solvent evaporation, High-throughput processing of up to 6 samples, Automated operation and monitoring, Seamless integration with purification systems. Experience the benefits of Advion Interchim's innovative technology and Inkarp's dedicated support.
                </p>
                <p class="font-semibold" >Our compact evaporator with multiple positions</p>
                <p class="font-semibold" >Super simple. Super smart.</p>
...
<div style="display:flex;flex-wrap:wrap;gap:20px;font-family:Roboto,sans-serif;color:#333;">
    <div style="flex:1 1 60%;min-width:300px;">
        <div style="padding-left:20px;">
            <div style="margin-bottom:10px;font-size:18px;line-height:1.6;" class="font-[Roboto] space-y-2">
                <p>Experience the power of integrated purification and analysis with puriFlash MS, a cutting-edge mass spectrometer system distributed and serviced by Advion Interchim and Inkarp Instruments in India. This innovative solution combines advanced flash purification with high-performance mass spectrometry, backed by premium support from Advion Interchim and Inkarp Instruments to ensure maximum productivity and efficiency in your laboratory.
                </p>
                ...
                <h2 class="text-xl font-[MaxOT] text-[#E63946]">Detect and collect your compounds in accordance with their molecular weight thanks to our single quadrupole mass spectrometer.</h2>
