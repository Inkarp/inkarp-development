...
export const HitachiProducts = {
  "nexta-dsc-series": {
    ...
    videoId: "",
    meta: {
      title: "Differential Scanning Calorimeter (DSC)　NEXTA® DSC series Thermal Analysis Distributor & Service Provider In India - Hitachi - Inkarp Instruments Pvt Ltd",
      description:
        "Explore the advanced Differential Scanning Calorimeter (DSC) NEXTA® DSC series for precise thermal analysis. Discover innovation with Hitachi & Inkarp Instruments, backed by extensive distribution and service networks across India.",
      keywords: [
        "Differential Scanning Calorimeter (DSC)　NEXTA® DSC series Thermal Analysis",
        "Hitachi NEXTA DSC",
    ...
    description: `
  <div class="mx-auto px-4 font-[Roboto] text-[#333]">
    <!-- Intro -->
    <div class="mb-5">
      <div class="mb-2.5 text-[18px] leading-[1.65]">
        <p>
          Inkarp Instruments, a trusted <span class="font-semibold">Hitachi</span> partner, presents the NEXTA DSC series, a premium Differential Scanning Calorimeter for thermal analysis in India. Ideal for R&amp;D, quality control, and material testing, Inkarp Instruments provides expert distribution, installation, training, and support for Hitachi's NEXTA DSC series.
        </p>
        <p>
          The NEXTA DSC series delivers superior sensitivity with exceptional baseline stability, wider Real View® temperature range, and specific heat capacity determination via the temperature modulated DSC method.
        </p>
        <p>
          Designed for user safety and reliability, NEXTA DSC provides cutting-edge measurement technology for polymers, inorganic materials, pharmaceuticals, and other industries.
        </p>
      </div>
    </div>
    ...
    <!-- Key Features -->
    <div class="mt-7">
      <h4 class="text-[20px] font-semibold my-4 font-['MaxOT','Roboto',sans-serif] text-[#BE0010]">Key Features</h4>
      <p>
        <strong>World-class baseline repeatability</strong><br />
      ...
      <p class="mt-3">
        <strong>Superior sensitivity</strong><br />
      ...
      <img src="/images/products/Hitachi/ana-nexta-dsc.jpg" alt="NEXTA DSC Series"
          class="max-w-full w-full border border-[#ddd] rounded-md my-4" />
      <img src="/images/products/Hitachi/ana-nexta-dsc-2.jpg" alt="NEXTA DSC Series"
          class="max-w-full w-full border border-[#ddd] rounded-md my-4" />

      <p class="mt-3">
        <strong>Wider Real View® range</strong><br />
    ...
    <img src="/images/products/Hitachi/ana-nexta-dsc-3.jpg" alt="NEXTA DSC Real View"
         class="max-w-full w-full border border-[#ddd] rounded-md my-4" />

    <p class="mt-3">
      <strong>Specific heat capacity measurement</strong><br />
    ...
    <img src="/images/products/Hitachi/ana-nexta-dsc-4.jpg" alt="NEXTA DSC Modulated"
         class="max-w-full w-full border border-[#ddd] rounded-md my-4" />
  </div>

  <!-- Specifications -->
  <div class="mt-7">
    <h4 class="text-[20px] font-semibold my-4 font-['MaxOT','Roboto',sans-serif] text-[#BE0010]">Specifications</h4>

    <div class="w-full overflow-x-auto">
      <table class="w-full text-[15px] my-2.5 border-collapse min-w-[720px] md:min-w-[820px]">
        <thead>
          <tr class="bg-gray-100">
            <th class="border border-neutral-500 p-2"></th>
            <th class="border border-neutral-500 p-2 text-left">DSC600</th>
            <th class="border border-neutral-500 p-2 text-left">DSC200</th>
          </tr>
        </thead>
        <tbody>
          <tr>
            <td class="border border-neutral-500 p-2">Measurement principle</td>
            <td class="border border-neutral-500 p-2" colspan="2">Heat Flux</td>
          </tr>
          <tr>
            <td class="border border-neutral-500 p-2">Temperature range</td>
            <td class="border border-neutral-500 p-2" colspan="2">-150℃ ～ 725℃</td>
          </tr>
          <tr>
            <td class="border border-neutral-500 p-2">DSC dynamic range</td>
            <td class="border border-neutral-500 p-2">±100 mW</td>
            <td class="border border-neutral-500 p-2">±200 mW</td>
          </tr>
          <tr>
            <td class="border border-neutral-500 p-2">RMS noise / Sensitivity</td>
            <td class="border border-neutral-500 p-2">0.05 µW / 0.1 µW</td>
            <td class="border border-neutral-500 p-2">0.1 µW / 0.2 µW</td>
          </tr>
          <tr>
            <td class="border border-neutral-500 p-2">Calorimetric precision</td>
            <td class="border border-neutral-500 p-2" colspan="2">±0.05% (10 consecutive measurements)</td>
          </tr>
          <tr>
            <td class="border border-neutral-500 p-2">Baseline repeatability</td>
            <td class="border border-neutral-500 p-2" colspan="2">±5 µW (-50 ~ 300°C, 10°C/min)</td>
          </tr>
          <tr>
            <td class="border border-neutral-500 p-2">Programmable rate</td>
            <td class="border border-neutral-500 p-2" colspan="2">0.01℃ ～ 100℃/min</td>
          </tr>
          <tr>
            <td class="border border-neutral-500 p-2">Purge gas</td>
            <td class="border border-neutral-500 p-2" colspan="2">Air, Inert gas</td>
          </tr>
          <tr>
            <td class="border border-neutral-500 p-2">Purge gas control</td>
            <td class="border border-neutral-500 p-2" colspan="2">Mass flow controller, 2 lines</td>
          </tr>
          <tr>
            <td class="border border-neutral-500 p-2">Auto Sampler *</td>
            <td class="border border-neutral-500 p-2" colspan="2">Max. 50 samples</td>
          </tr>
          <tr>
            <td class="border border-neutral-500 p-2">Electrical Cooling Unit *</td>
            <td class="border border-neutral-500 p-2" colspan="2">-80℃ ～ 500℃</td>
          </tr>
          <tr>
            <td class="border border-neutral-500 p-2">Auto LN2 Cooling Unit *</td>
            <td class="border border-neutral-500 p-2" colspan="2">-150℃ ～ 725℃</td>
          </tr>
          <tr>
            <td class="border border-neutral-500 p-2">Auto Air Cooling Unit *</td>
            <td class="border border-neutral-500 p-2" colspan="2">Ambient ～ 725℃</td>
          </tr>
        </tbody>
      </table>
    </div>
  ...
  <!-- Solar Encapsulant Application Section -->
  <div class="mt-9">
    <h2 class="text-[24px] leading-[34px] font-bold mb-2 font-['MaxOT','Roboto',sans-serif] text-[#1a1a1a]">
      Hitachi Encapsulant Solution for Solar Modules
    </h2>

    <div class="text-[16px] leading-[1.65] my-2.5">
      <p>
        A photovoltaic module or system consists of many jointly connected solar cells packaged between a back sheet on the bottom
        and a tempered-glass window on the top. The cells are encapsulated by a polymer encapsulant that provides mechanical support,
        electrical isolation, and protection against outdoor environmental elements such as moisture, UV radiation, and temperature stress.
        While multiple materials can be used, a commonly adopted encapsulant is EVA (ethylene-vinyl-acetate), a thermoset copolymer elastomer
        supplied in sheet form for PV module encapsulation.
      </p>
      <p class="mt-2">
        EVA offers several desirable properties that make it the material of choice for PV modules:
      </p>

      <ul class="pl-5 my-2 list-disc marker:text-[#BE0010]">
        <li class="my-1.5">Not adhesive at room temperature for easy handling during lay-up.</li>
        <li class="my-1.5">Forms a permanent, tight seal through crosslinking and enhanced bonding when the film is heated and pressed.</li>
        <li class="my-1.5">
          After crosslinking, exhibits high optical transmittance and strong adhesion to module materials, with good dielectric properties
          and excellent moisture barrier performance—while maintaining adequate mechanical compliance to accommodate thermal stresses caused
          by different expansion coefficients.
        </li>
      </ul>

      <p class="mt-2">
        During the PV lamination process, the EVA sheet is placed between the solar cells and the back sheet/glass, then heated, pressed,
        and cured for a defined time at elevated temperature. Because the final properties depend strongly on degree of cure, it is essential
        to monitor cure to optimize encapsulation. Differential Scanning Calorimetry (DSC) is a standard method to study curing behavior,
        determine degree of cure, and extract curing kinetics.
      </p>
      <p class="mt-2">
        Typical curves for glass transition (T<sub>g</sub>) and cross-linking reactions—distinguishing partially cured vs. uncured resin—are
        illustrated below.
      </p>
    </div>

    <img
      src="/images/products/Hitachi/graph.png"
      alt="DSC graph showing Tg and crosslinking for partially/uncured resin"
      class="max-w-full w-full border border-[#ddd] rounded-md my-3.5"
    />
  </div>
</div>
...
`
  ...
  "nexta-sta-series": {
    ...
    videoId: "",
    meta: {
      title: "Simultaneous Thermogravimetric Analyzer NEXTA STA Series Thermal Analysis Distributor & Service Provider In India - Hitachi - Inkarp Instruments Pvt Ltd",
      description:
        "Explore the NEXTA STA Series for precise thermal analysis. Discover unmatched performance and innovative features at Inkarp Instruments Pvt Ltd, backed by extensive distribution and service networks across India.",
      keywords: [
        "Simultaneous Thermogravimetric Analyzer NEXTA STA Series Thermal Analysis",
        "Hitachi NEXTA STA",
    ...
    description: `
      <div style="margin:0 auto;padding:0 16px;font-family:Roboto;color:#333;">
        ...
        <div style="margin-top:30px;">
          ...
          <p>The NEXTA STA series showcases an evolution from DTA to DSC, enabling simultaneous thermogravimetry and DSC measurement, which defines it from its predecessors. In addition, by using temperature modulated DSC, specific heat capacity measurements are achieved over a wide temperature range that cannot be measured by (the) standalone DSC.</p>
          ...
          <p>Not only are samples observed while measurements are in progress, but various analysis features have been incorporated, such as digital zoom, image analysis, length measurement capability, and color analysis, which can support a variety of applications.</p>
  ...
  "tma7000-series": {
    ...
    videoId: "",
    meta: {
      title: "Thermomechanical Analyzer TMA7000 Series Thermal Analysis Distributor & Service Provider In India - Hitachi - Inkarp Instruments Pvt Ltd",
      description:
        "Explore the Thermomechanical Analyzer TMA7000 Series by Hitachi. Enhance your thermal analysis with advanced features from Inkarp Instruments Pvt Ltd, backed by extensive distribution and service networks across India.",
      keywords: [
        "Thermomechanical Analyzer TMA7000 Series Thermal Analysis",
        "Hitachi TMA7000",
...
<div style="margin:0 auto;padding:0 16px;font-family:Roboto;color:#333;">
  ...
  <div style="margin-top:30px;"  class="space-y-2">
    <h4 style="font-size:20px;font-weight:600;margin:18px 0 10px;font-family:MaxOT;color:#E63946;">Features</h4>
    ...
    <p class="text-lg"><strong>Effective Atmosphere Control</strong></p>
    ...
    <h4 style="font-size:20px;font-weight:600;margin:18px 0 10px;font-family:MaxOT;color:#E63946;">Specifications</h4>
    <table style="border-collapse:collapse;width:100%;font-size:15px;margin:10px 0;">
      <tbody>
        <tr>
...
`
  ...
  "software-for-nexta": {
    ...
    videoId: "",
    meta: {
      title: "Software for NEXTA Thermal Analysis Distributor & Service Provider In India - Hitachi - Inkarp Instruments Pvt Ltd",
      description:
        "Explore advanced Software for NEXTA Thermal Analysis from Hitachi. Optimize your thermal testing with cutting-edge solutions from Inkarp Instruments Pvt Ltd, backed by extensive distribution and service networks across India.",
      keywords: [
        "Software for NEXTA Thermal Analysis",
...
<div style="margin:0 auto;padding:0 16px;font-family:Roboto;color:#333;">
  <div style="margin-bottom:20px;">
    <div style="font-size:18px;line-height:1.8;">
      <p>Inkarp Instruments, a trusted Hitachi partner, offers advanced software solutions for NEXTA Thermal Analysis in India. Inkarp Instruments provides expert distribution, installation, training, and support for Hitachi's NEXTA software, empowering Indian researchers to optimize thermal analysis, streamline workflows, and make informed decisions in materials science, pharmaceuticals, polymers, and other industries. Efficient data management and accurate results guaranteed.
      </p>
  ...
  <div style="margin-top:30px;">
    <h4 style="font-size:20px;font-weight:800;margin:18px 0 12px;font-family:MaxOT;color:#E63946;">Features</h4>
...
<div style="margin:0 auto;padding:0 16px;font-family:Roboto;color:#333;">
  ...
  <div style="margin-top:30px;">
    <h4 style="font-size:20px;font-weight:600;margin:18px 0 12px;font-family:MaxOT;color:#E63946;">Specifications</h4>
    <table style="border-collapse:collapse;width:100%;font-size:15px;margin:10px 0;">
      <tbody>
        <tr>
...
`
  ...
  "real-view-sample-observation-unit": {
    ...
    videoId: "",
    meta: {
      title: "Real View® Sample Observation Unit Thermal Analysis Distributor & Service Provider In India - Hitachi - Inkarp Instruments Pvt Ltd",
      description:
        "Discover the Real View® Sample Observation Unit for precise thermal analysis. Enhance your research with Hitachi technology at Inkarp Instruments Pvt Ltd, backed by extensive distribution and service networks across India.",
      keywords: [
        "Real View® Sample Observation Unit Thermal Analysis",
        "Hitachi Real View",
...
`
  ...
  "data-input-and-output-optional-software": {
    ...
    videoId: "",
    meta: {
      title: "Data Input and Output Optional Software Thermal Analysis Distributor & Service Provider In India - Hitachi - Inkarp Instruments Pvt Ltd",
      description:
        "Discover Hitachi's Data Input and Output Optional Software for precise thermal analysis. Enhance your productivity with exceptional data management solutions, backed by extensive distribution and service networks across India.",
      keywords: [
        "Data Input and Output Optional Software Thermal Analysis Distributors & services In India",
...
<div style="margin:0 auto;padding:0 16px;font-family:Roboto,;color:#333;">
  ...
  <div style="margin-top:30px;">
    <h4 style="font-size:20px;font-weight:600;margin:18px 0 12px;font-family:MaxOT;color:#E63946;">Overview and How to Use</h4>
