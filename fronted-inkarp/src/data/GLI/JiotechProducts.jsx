...
export const JiotechProducts = {
  "autoclaves": {
    ...
    // videoId: "DBJ_Gs5H76Y",
    meta: {
      title: "Autoclaves Distributor & Service Provider in India | Jeiotech | Inkarp",
      description: "Discover Jeiotech Autoclaves in India with Inkarp – trusted distributor & service provider. Explore advanced sterilization solutions for pharma, biotech, research, and clinical labs.",
      keywords: [
        'Best Autoclaves in India', 'Vertical Autoclaves', ' Jeiotech Autoclaves India', ' Laboratory Autoclaves', ' Top Loading Autoclaves', 'Autoclave Sterilizers India', ' Laboratory Sterilization Equipment', ' Autoclave Supplier in India', 'Autoclave Distributor India', 'Autoclaves for Research Labs', ' Autoclave Distributor In India', 'Autoclave Service Provider In India'
      ],
      altText: "Jeiotech_Autoclaves",
      internalLinks: ["https://inkarp.co.in/contactUs"],
      externalLinks: ["https://www.jeiotech.com/eng/product/product.php?ptype=view&prdcode=1512290001&catcode=101000&page=&searchopt=&searchkey="]
    },
    description: `<div class="ink-autoclaves">
  <style>
    .ink-autoclaves{font-family:Roboto,color:#222;line-height:1.55}
    .ink-wrap{max-width:1100px;margin:0 auto;padding:18px;border-radius:14px;background:#fff}
    .ink-kicker{display:inline-block;background:#be0010;color:#fff;font-weight:700;padding:6px 12px;border-radius:999px;margin-bottom:10px;font-size:14px}
    h2{font-family:MaxOT,Roboto,Arial,sans-serif;color:#E63946;margin:10px 0 6px;font-size:24px}
    h3{font-weight:700;margin:16px 0 8px;color:#333}
    p{margin:0 0 10px}
    ul{margin:0 0 12px 18px}
    li{margin:4px 0}
    .ink-note{background:#fff9f7;border-left:4px solid #E63946;padding:10px 12px;border-radius:8px;margin:12px 0}
    /* tables */
    .tbl{width:100%;border-collapse:collapse;margin:14px 0;border:1px solid #ddd}
    .tbl th,.tbl td{border:1px solid #e5e5e5;padding:9px 10px;vertical-align:top}
    .tbl th{background:#fafafa;font-weight:700;text-align:left}
    .tbl thead th{background:#f2f6ff}
    .chip{display:inline-block;background:#f1f1f1;border-radius:6px;padding:2px 8px;font-size:12px;margin-right:6px}
  ...
  <div class="ink-wrap">
    <h2>Best Autoclaves in India</h2>
    <p>When it comes to reliable sterilization in laboratories, hospitals, and research centers, <strong>Vertical Autoclaves</strong> are among the best autoclaves in India. Designed for efficiency and safety, these top-loading systems use high-pressure saturated steam to sterilize glassware, instruments, culture media, and laboratory supplies with precision. Their vertical construction makes them compact yet spacious, allowing labs to maximize floor space while handling higher load capacities.</p>
    <p>One of the biggest advantages of vertical autoclaves is their user-friendly operation. Most modern models are equipped with digital or microprocessor-based controls that allow users to set and monitor sterilization temperature, pressure, and cycle time with ease. Automatic operation cycles ensure hassle-free sterilization—from heating, sterilizing, and pressure release to cycle completion—minimizing manual intervention. This makes them ideal for busy laboratories that demand consistency and repeatability.</p>
    <p>Performance and versatility are also key highlights of vertical autoclaves. They typically support sterilization temperatures ranging between 110°C and 135°C, making them suitable for a wide range of applications including culture media preparation, sterilization of surgical instruments, and decontamination of laboratory waste. Vertical autoclaves are available in different chamber sizes, allowing institutions to choose models that fit their workload requirements.</p>
    <p>From a safety standpoint, vertical autoclaves come with multiple layers of protection. Features like automatic pressure release valves, temperature cut-offs, water level indicators, and alarms reduce operational risks. The top-loading design, combined with insulated chambers and low-conductivity covers, further enhances user safety during operation.</p>
    <p>In terms of construction and durability, vertical autoclaves generally feature stainless-steel chambers that are resistant to corrosion and ensure long-term reliability. Many models also come with stackable baskets, allowing efficient use of chamber space while maintaining sterilization effectiveness. Easy-to-replace gaskets and low-maintenance designs make them cost-effective over time.</p>
    <p>With increasing demand in India’s pharmaceutical, biotech, food testing, and healthcare industries, vertical autoclaves are becoming the preferred choice for laboratories seeking precision, safety, and convenience. Whether you are a small diagnostic center or a large research institute, investing in the best vertical autoclaves ensures uncompromised sterilization, regulatory compliance, and dependable performance.</p>

   
    <div class="ink-note">
      <strong>Safety-first design:</strong> automatic pressure release valves, temperature cut-offs, water-level monitoring, and alarms reduce operational risk. Stainless-steel chambers, stackable baskets, and easy-to-replace gaskets deliver durability and low maintenance.
    </div>

    <h2>Jeiotech Autoclaves in India — Highlights</h2>

    <h3>Performance</h3>
    <ul>
      <li><strong>Microprocessor control</strong> with temperature calibration for high-precision sterilization.</li>
      <li>Sterilization temperature: <strong>110–123 °C</strong>.</li>
      <li>Melting temperature: <strong>60–100 °C</strong> <span class="muted">(*Liquefaction of coagulated agar media)</span>.</li>
      <li><strong>Automatic sterilization system</strong> for unattended operation:
        <span class="chip">Heating</span><span class="chip">Safety Check</span><span class="chip">Sterilization</span><span class="chip">Sterilization Safe Hold</span><span class="chip">Exhausting</span><span class="chip">End</span>
      </li>
      <li><strong>Standard modes and program modes are listed in detail as below tables.
 Temperature calibration function for precision sterilization.</li>
    </ul>
    ...
    <div class="grid">
      <div>
        ...
        <table class="tbl">
          <thead>
            <tr><th>Mode</th><th>Temp (°C)</th><th>Time (min)</th></tr>
          </thead>
          <tbody>
            <tr><td>Decontamination</td><td>121</td><td>35</td></tr>
            <tr><td>Solids sterilization</td><td>121</td><td>20</td></tr>
            <tr><td>Liquids sterilization</td><td>121</td><td>15</td></tr>
            <tr><td>Melting</td><td>100</td><td>30</td></tr>
          </tbody>
        </table>
      </div>
      <div>
        ...
        <table class="tbl">
          ...
          <tbody>
            <tr><td>Sterilization 1</td><td>110–123</td><td>1–999</td></tr>
            <tr><td>Sterilization 2</td><td>110–123</td><td>1–999</td></tr>
            <tr><td>Liquid sterilization</td><td>110–123</td><td>1–999</td></tr>
            <tr><td>Melting</td><td>60–100</td><td>1–999</td></tr>
          </tbody>
        </table>
      </div>
    </div>
    ...
    <h3>Convenience</h3>
    <ul>
      <li>Independent <strong>control display</strong>, process display, and pressure gauge.</li>
      <li><strong>VFD</strong> visualization of temperature, pressure (optional), timer, and warnings + <strong>LED process</strong> lamps.</li>
      <li>Top-loading vertical design with <strong>stackable baskets</strong> to maximize chamber space.</li>
      <li><strong>Stainless-steel chamber</strong> (corrosion-resistant) and easy-to-replace silicone gasket.</li>
      <li>Optional <strong>6-point dot recorder</strong> for documentation.</li>
    </ul>

    <h3>Safety</h3>
    <div class="grid">
      <div>
        <strong>Mechanical devices</strong>
        <ul>
          <li>Over-current protection</li>
          <li>Over-temperature protection with automatic power cutoff</li>
          <li>Over-pressure protection (automatic &amp; manual safety valves)</li>
        </ul>
      </div>
      <div>
        <strong>Warning systems</strong>
        <ul>
          <li>Over-temperature / Low-temperature alerts</li>
          <li>Low water level warning</li>
          <li>Low heat (if set temperature is not reached)</li>
          <li>Sterilization fail (unexpected stop)</li>
          <li>Slide-opening door with low-conductivity plastic cover to prevent burns</li>
        </ul>
      </div>
    </div>
    ...
    <table class="tbl">
      ...
      <tbody>
        <tr><th>Control</th><td colspan="4">Microprocessor PID control</td></tr>
        <tr><th>Chamber volume (L / cu ft)</th><td>50 / 1.76</td><td>65 / 2.29</td><td>85 / 3.0</td><td>105 / 3.7</td></tr>
        <tr><th>Sterilization temp. (°C / °F)</th><td colspan="4">110 to 123 / 230 to 253.4</td></tr>
        <tr><th>Melting temp. (°C / °F)</th><td colspan="4">60 to 100 / 140 to 212</td></tr>
        <tr><th>Pressure at 121 °C (kg/cm²)</th><td colspan="4">1.1 to 1.2</td></tr>
        <tr><th>Gauge range (analog, MPa)</th><td colspan="4">−0.1 to 0.6</td></tr>
        <tr><th>Permissible altitude (m)</th><td colspan="4">Up to 800</td></tr>
        <tr><th>Safety</th><td colspan="4">Over temperature protector / Pressure safety valve / Over current protector</td></tr>
        <tr><th>Warnings</th><td colspan="4">Over temp. / Low temp. / Low heat / Sterilization fail / Low water level</td></tr>
        <tr><th>Timer</th><td colspan="4">0 to 999 min</td></tr>

        <tr><th>Interior (W×H) mm / inch</th>
          <td>400×458 / 15.75×18.03</td>
          <td>400×558 / 15.75×21.97</td>
          <td>400×758 / 15.75×29.84</td>
          <td>400×908 / 15.75×35.75</td>
        </tr>

        <tr><th>Exterior (W×D×H) mm / inch</th>
          <td>624×672×870 / 24.57×26.46×34.25</td>
          <td>624×672×971 / 24.57×26.46×38.23</td>
          <td>624×672×1083 / 24.57×26.46×42.64</td>
          <td>624×672×1233 / 24.57×26.46×48.54</td>
        </tr>

        <tr><th>Exterior with exhaust tank (W×D×H) mm / inch</th>
          <td>722×672×870 / 28.42×26.46×34.25</td>
          <td>722×672×971 / 28.42×26.46×38.23</td>
          <td>722×672×1083 / 28.42×26.46×42.64</td>
          <td>722×672×1233 / 28.42×26.46×48.54</td>
        </tr>

        <tr><th>Basket (Ø×H) mm / inch</th>
          <td>380×180 / 14.96×7.09</td>
          <td>380×230 / 14.96×9.05</td>
          <td>380×330 / 14.96×12.99</td>
          <td>380×405 / 14.96×15.94</td>
        </tr>

        <tr><th>Net weight (kg / lbs)</th>
          <td>94.5 / 208.34</td>
          <td>99.5 / 219.36</td>
          <td>104 / 229.28</td>
          <td>110 / 242.51</td>
        ...
        <tr><th>Electrical requirements (230 V, 50/60 Hz)</th>
          <td>14.3 A</td>
          <td>14.3 A</td>
          <td>14.3 A</td>
          <td>21.3 A</td>
